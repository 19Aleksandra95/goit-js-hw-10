...
axios.defaults.headers.common["x-api-key"] = "live_5sSXvCuM4gtE83cQzkJUAm0LH8zb3ibJJfD7hGuph2GegLsG5eav3aJMVZwDa4pf";
...
function renderMarkupInfo(data) {
    ...
    const beerdCard = `<img class="photo-cat" width = "300px" src="${url}" alt="${name}">
    <div class="text-part">
